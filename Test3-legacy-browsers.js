...
async function updateInfo() {
  ...
  psychoJS.experiment.dataFileName = (("." + "/") + `https://github.com/gzugiz/FirstTest/tree/main/data/${expInfo["date"]}`);
...
function GoodbyeRoutineEachFrame() {
  return async function () {
    ...
    frameRemains = 0.1 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
